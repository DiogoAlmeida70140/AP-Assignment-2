...
def boltzmann_policy(model, state, temperature, device, episode=0, big_episode=0):
    """
    Select an action using a Boltzmann (softmax) distribution over Q-values.
    """
    ...
    if big_episode % 100 == 0 and episode % 20 == 0:
